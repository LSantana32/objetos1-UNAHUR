...
class CaramelosConCorazonDeChocolate inherits Caramelo{
...
class ObleaCrujiente inherits Oblea{
	...
	override method mordisco(){
		cantMordidas+=1
		if (cantMordidas<=3)super()+3
		else super()
	}
	method estaDebil()= cantMordidas>3
}
...
class ChocolatinVip inherits Chocolatin{
	...
	method humedad(gradoDeHumedad){
		humedad=gradoDeHumedad
	}
